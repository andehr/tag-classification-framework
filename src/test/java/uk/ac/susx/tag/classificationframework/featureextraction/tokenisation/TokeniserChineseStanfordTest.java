...
public class TokeniserChineseStanfordTest {
    ...
    private FeatureExtractionPipeline buildPipeline() {
        return new PipelineBuilder().build(new PipelineBuilder.OptionList() // Instantiate the pipeline.
    ...
    public void tokenise1() throws Exception {
        FeatureExtractionPipeline pipeline = buildPipeline();
